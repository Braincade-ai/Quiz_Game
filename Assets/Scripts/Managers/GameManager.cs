...
#pragma warning disable 649
    [SerializeField] private LevelManager quizManager;               //ref to the QuizManager script
    [SerializeField] private CameraManager categoryBtnPrefab;
...
#pragma warning restore 649
    ...
    public void SetQuestion(Question question)
    {
        ...
        List<string> ansOptions = AudioManager.ShuffleListItems<string>(question.options);
    ...
    {   
        ...
        for (int i = 0; i < quizManager.QuizData.Count; i++)
        {
            ...
            CameraManager categoryBtn = Instantiate(categoryBtnPrefab, scrollHolder.transform);
